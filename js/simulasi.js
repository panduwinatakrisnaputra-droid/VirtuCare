...
const createScene = async function () {
    ...
    chestTarget.position = new BABYLON.Vector3(-14.55, 1.3, 27.1);
    ...
    armTarget.position = new BABYLON.Vector3(-14, 1.1, 27);
        ...
        new BABYLON.ExecuteCodeAction(
            ...
            function () {
                if (!isProcessing && isTensimeterAttached) { // Ditambahkan isTensimeterAttached check
                    ...
                    tensimeterMesh.rotation = new BABYLON.Vector3(-90*DEG_TO_RAD, 90*DEG_TO_RAD, 90*DEG_TO_RAD); 
                    setHierarchicalPickable(tensimeterMesh, false); 
                    // ------------------------
